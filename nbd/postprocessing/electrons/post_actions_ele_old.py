...
target_dictionary = {
    ...
    "MElectron_etaMinusGen": [["i", np.tan, [100, 0]], ["a", "GenElectron_eta"]],
    ...
    "MElectron_phiMinusGen": [["i", np.tan, [80, 0]], ["a", "GenElectron_phi"]],
    "MElectron_ptRatio": [["i", np.tan, [10, -10]], ["m", "GenElectron_pt"]],
